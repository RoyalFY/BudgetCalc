...
})({"nE6a8":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "b4639704a23f1c26";
"use strict";
...
(async function() {
    const taxing = localStorage.getItem("taxes");
    const medicinal = localStorage.getItem("meds");
    const hungry = localStorage.getItem("foods");
    const apartments = localStorage.getItem("houses");
    const bank = localStorage.getItem("savings");
    const relocation = localStorage.getItem("travels");
    const data = {
        labels: [
            "Children",
            "Medical",
    ...
    let banana1 = new (0, _autoDefault.default)(document.getElementById("chart"), {
        type: "pie",
        data: data
    });
})();
document.addEventListener(`DOMContentLoaded`, ()=>{
    ...
    let addListener = function(id, event, code) {
        elementById(id).addEventListener(event, (eventData)=>{
            code(eventData);
        });
    };
    addListener(`AAAAAAAAAA`, `click`, (eventData)=>{
        ...
        localStorage.setItem(`foods`, meal);
        localStorage.setItem(`houses`, homes);
        localStorage.setItem(`saves`, holdings);
        localStorage.setItem(`travels`, trav);
        // const pie = localStorage.getItem(`Piebanana`)
        // console.log(pie.data)
        banana.data.datasets[0].data = [
            taxes,
            med,
            meal,
            homes,
...
},{}]},["nE6a8","grVca"], "grVca", "parcelRequire61b9")

//# sourceMappingURL=index.a23f1c26.js.map
